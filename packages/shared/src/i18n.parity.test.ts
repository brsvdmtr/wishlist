...
const KNOWN_BACKLOG = new Set<string>([
  ...
  'gg_actions',
  'gg_amount_placeholder',
  'gg_badge_organizer',
  'gg_badge_participant',
  'gg_cancel',
  'gg_cancel_confirm',
  'gg_chat_input_ph',
  'gg_chat_pinned',
  ...
  'gg_progress',
  'gg_remaining',
  'gg_reservation_badge',
  'gg_reservation_organizer',
  'gg_reservation_you_organizer',
  'gg_section_manage',
  'gg_share',
  'gg_share_text',
  'gg_status_cancelled',
  'gg_status_completed',
  'gg_status_open',
  'gg_toast_amount_updated',
  'gg_toast_cancelled',
  'gg_toast_completed',
  'gg_toast_created',
  'gg_toast_joined',
  'gg_toast_left',
  'gg_toast_link_copied',
  'gg_toast_pinned_updated',
  'gg_write_chat',
  'gn_brand',
  'gn_demo_header',
  'gn_demo_ideas_count',
  'gn_demo_person_anniv',
  'gn_demo_person_mom',
  'gn_demo_person_ny',
  'gn_demo_title_anniv',
  'gn_demo_title_mom',
  'gn_demo_title_ny',
  'gn_empty_cta_custom',
  'gn_empty_small_birth',
  'gn_empty_small_graduation',
  'gn_empty_small_housewarming',
  'gn_empty_small_other',
  'gn_empty_template_anniv',
  'gn_empty_template_bday',
  'gn_empty_template_holiday',
  'gn_empty_template_tap',
  'gn_empty_templates_header',
  'gn_faq_a_notify',
  'gn_faq_a_pro',
  'gn_faq_a_recurring',
  'gn_faq_q_notify',
  ...
  'gn_feat_push_body',
  'gn_feat_push_title',
  'gn_feat_recurring_body',
  'gn_feat_recurring_title',
  'gn_feat_unlimited_body',
  'gn_feat_unlimited_title',
  'gn_ob_next',
  'gn_ob_s1_body',
  'gn_ob_s1_c1',
  'gn_ob_s1_c2',
  ...
  'gn_ob_s2_chip_anniv',
  'gn_ob_s2_chip_bday',
  'gn_ob_s2_chip_holiday',
  'gn_ob_s2_chip_once',
  'gn_ob_s2_chip_yearly',
  'gn_ob_s2_demo_date',
  'gn_ob_s2_demo_person',
  'gn_ob_s2_info',
  'gn_ob_s2_label_recurring',
  'gn_ob_s2_label_type',
  'gn_ob_s2_label_when',
  'gn_ob_s2_label_who',
  'gn_ob_s2_title',
  ...
  'gn_ob_s3_demo_title',
  'gn_ob_s3_idea_1',
  'gn_ob_s3_idea_1_price',
  'gn_ob_s3_idea_2',
  'gn_ob_s3_idea_2_price',
  'gn_ob_s3_idea_3',
  'gn_ob_s3_idea_3_price',
  'gn_ob_s3_info',
  'gn_ob_s3_title',
  'gn_ob_s4_body',
  'gn_ob_s4_cta',
  ...
  'gn_ob_skip',
  'gn_price_approx',
  'gn_price_chip_forever_b',
  'gn_price_chip_forever_t',
  'gn_price_chip_pro_b',
  'gn_price_chip_pro_t',
  'gn_price_chip_unlimited_b',
  'gn_price_chip_unlimited_t',
  'gn_price_ribbon',
  'gn_price_subtext',
  'gn_social_proof',
