...
|---|---|---|---|
| Hint credits | `UserCredits.hintCredits` | `POST /tg/items/:id/hint` (−1) | да |
...
| **Hints** | Hard 402 | 3 hints/мес FREE | Hints — soft-virality, "намекни другу" — каждое использование тянет к диалогу |
