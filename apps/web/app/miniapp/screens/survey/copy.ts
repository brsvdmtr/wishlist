...
export interface SurveyCopy {
  ...
  // Transient warning surfaced when the user clicks past the cap on a
  // multi-question. UI fades it out after a couple seconds. {{max}}.
  multiCapHit: string;
  npsHint: string;
  btn: {
    next: string;
...
const ru: SurveyCopy = {
  ...
  multiCapHit: 'Можно выбрать не больше {{max}} вариантов',
  ...
  q: {
    q1: {
      ...
      options: {
        ...
        birthday_self: 'Скоро мой день рождения',
        ...
        replace_other_tool: 'Чтобы не вести список в заметках или Excel',
        other: 'Другое',
      },
    },
    q2: {
    ...
    q4: {
      ...
      options: {
        ...
        url_import_broken: 'Вставка ссылок работала плохо',
        friends_not_in_telegram: 'Друзья не в Telegram',
        nobody_to_share_with: 'Некому отправить вишлист',
        forgot_to_use: 'Забывал возвращаться в приложение',
        not_enough_features: 'Не хватает функций',
        bugs_or_crashes: 'Баги и сбои',
    ...
    q6: {
      ...
      options: {
        reminders_birthdays: 'Напоминания о днях рождения друзей',
        reminders_my_own: 'Напоминания возвращаться в приложение',
        url_import_better: 'Надёжная вставка ссылок',
        shopping_assistant: 'Помощь с подбором подарка',
        group_gifting: 'Сбор на подарок с друзьями',
        price_drop_alerts: 'Уведомления о снижении цен',
        friends_already_inside: 'Если бы друзья уже пользовались WishBoard',
        web_version: 'Веб-версия',
        nothing_would_help: 'Пожалуй, ничего',
        other: 'Другое',
      },
    },
    q7: {
      ...
      options: {
        unlimited_wishlists: 'Безлимит на вишлисты',
        unlimited_items: 'Безлимит на желания',
        ai_suggestions: 'AI-подсказки и идеи подарков',
        group_gifting: 'Сбор на подарок с друзьями',
        private_wishlists: 'Приватные вишлисты',
        secret_santa: 'Тайный Санта',
        price_tracking: 'Отслеживание цен',
        premium_calendar: 'Расширенный календарь событий',
        gift_history: 'История подарков',
        nothing_worth_paying: 'Ничего из этого не стоит денег',
        other: 'Другое',
      },
    },
    q8: {
...
const en: SurveyCopy = {
  ...
  multiCapHit: 'You can pick at most {{max}}',
