...
const ru: Dict = {
  ...
  cancel_feat_items: 'До 100 желаний в каждом',
  cancel_feat_participants: 'До 20 участников',
  cancel_feat_comments: 'Комментарии',
  cancel_feat_url: 'Добавление желания по ссылке',
  ...
  settings_app_behavior_title: 'Поведение приложения',
...
const en: Dict = {
  ...
  cancel_feat_items: 'Up to 100 wishes each',
  ...
  settings_app_behavior_title: 'App behavior',
