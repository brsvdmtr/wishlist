...
describe('resolver → t() integration coverage', () => {
  ...
  const LOCALE_FIX_KEYS = [
    ...
    // 2026-05-17 (iter 2) — dont_gift_* full block + paywall plan_pro_f15-19
    // (was English stubs / missing in zh-CN/hi/es/ar) + settings_dont_gift stub fix
    'dont_gift_banner_cta',
    'dont_gift_banner_dismiss',
    'dont_gift_banner_subtitle',
    'dont_gift_banner_title',
    'dont_gift_comment_hint',
    'dont_gift_comment_label',
    'dont_gift_comment_placeholder',
    'dont_gift_custom_add',
    'dont_gift_custom_label',
    'dont_gift_custom_placeholder',
    'dont_gift_edit_subtitle',
    'dont_gift_edit_title',
    'dont_gift_empty_btn',
    'dont_gift_empty_hint',
    'dont_gift_empty_title',
    'dont_gift_filled',
    'dont_gift_guest_count',
    'dont_gift_guest_separator',
    'dont_gift_guest_title',
    'dont_gift_mode_global',
    'dont_gift_mode_global_desc',
    'dont_gift_mode_global_status',
    'dont_gift_mode_hidden',
    'dont_gift_mode_hidden_desc',
    'dont_gift_mode_local',
    'dont_gift_mode_local_desc',
    'dont_gift_preset_alcohol',
    'dont_gift_preset_candles',
    'dont_gift_preset_clothes',
    'dont_gift_preset_cosmetics',
    'dont_gift_preset_flowers',
    'dont_gift_preset_food',
    'dont_gift_preset_gift_cards',
    'dont_gift_preset_jewelry',
    'dont_gift_preset_perfume',
    'dont_gift_preset_shoes',
    'dont_gift_preset_soft_toys',
    'dont_gift_preset_souvenirs',
    'dont_gift_preset_sweets',
    'dont_gift_preset_tech',
    'dont_gift_presets_label',
    'dont_gift_preview_label',
    'dont_gift_save',
    'dont_gift_saved',
    'dont_gift_settings_hint',
    'dont_gift_settings_label',
    'dont_gift_title',
    'dont_gift_visible_label',
    'plan_pro_f15',
    'plan_pro_f16',
    'plan_pro_f17',
    'plan_pro_f18',
    ...
    'plan_pro_sub18',
    'plan_pro_sub19',
    'settings_desc_dont_gift',
    'settings_dont_gift',
    'upsell_dont_gift_b1',
    'upsell_dont_gift_b2',
    'upsell_dont_gift_b3',
    'upsell_dont_gift_banner_b1',
    'upsell_dont_gift_banner_b2',
    'upsell_dont_gift_banner_b3',
    'upsell_dont_gift_banner_subtitle',
    'upsell_dont_gift_banner_title',
    'upsell_dont_gift_subtitle',
    'upsell_dont_gift_title',
  ];
