...
const SETTINGS_CATALOG: readonly SettingsRow[] = [
  {
    ...
    type: 'setting',
    icon: '👤',
    titles: { ru: 'Профиль', en: 'Profile', 'zh-CN': '个人资料', hi: 'प्रोफ़ाइल', es: 'Perfil', ar: 'الملف الشخصي' },
  ...
  },
  {
    ...
    type: 'setting',
    icon: '🔔',
    titles: { ru: 'Уведомления', en: 'Notifications', 'zh-CN': '通知', hi: 'नोटिफिकेशन', es: 'Notificaciones', ar: 'الإشعارات' },
  ...
  },
  {
    ...
    type: 'setting',
    icon: '⭐',
    titles: { ru: 'WishBoard PRO', en: 'WishBoard PRO', 'zh-CN': 'WishBoard PRO', hi: 'WishBoard PRO', es: 'WishBoard PRO', ar: 'WishBoard PRO' },
  ...
  },
  {
    ...
    type: 'setting',
    icon: '🎁',
    titles: { ru: 'Пригласить друга', en: 'Invite a friend', 'zh-CN': '邀请朋友', hi: 'दोस्त को आमंत्रित करें', es: 'Invitar a un amigo', ar: 'دعوة صديق' },
  ...
  },
  {
    ...
    type: 'setting',
    icon: '🔒',
    titles: { ru: 'Приватность', en: 'Privacy', 'zh-CN': '隐私', hi: 'गोपनीयता', es: 'Privacidad', ar: 'الخصوصية' },
  ...
  },
  {
    ...
    type: 'setting',
    icon: '🎨',
    titles: { ru: 'Оформление', en: 'Appearance', 'zh-CN': '外观', hi: 'लुक', es: 'Apariencia', ar: 'المظهر' },
  ...
  },
  {
    ...
    type: 'setting',
    icon: '🌐',
    titles: { ru: 'Язык', en: 'Language', 'zh-CN': '语言', hi: 'भाषा', es: 'Idioma', ar: 'اللغة' },
  ...
  },
  {
    ...
    type: 'setting',
    icon: '📅',
    titles: { ru: 'Календарь подарков', en: 'Gift calendar', 'zh-CN': '礼物日历', hi: 'गिफ्ट कैलेंडर', es: 'Calendario de regalos', ar: 'تقويم الهدايا' },
  ...
  },
  {
    ...
    type: 'setting',
    icon: '🚫',
    titles: { ru: 'Что не стоит дарить', en: 'Don’t gift list', 'zh-CN': '请勿赠送', hi: 'क्या न दें', es: 'Qué no regalar', ar: 'ما لا تُهدي' },
  ...
  },
  {
    ...
    type: 'faq',
    icon: '💡',
    titles: { ru: 'Частые вопросы', en: 'FAQ', 'zh-CN': '常见问题', hi: 'अक्सर पूछे जाने वाले प्रश्न', es: 'Preguntas frecuentes', ar: 'الأسئلة الشائعة' },
  ...
  },
  {
    ...
    type: 'faq',
    icon: '📄',
    titles: { ru: 'Юридическая информация', en: 'Legal', 'zh-CN': '法律信息', hi: 'कानूनी जानकारी', es: 'Información legal', ar: 'المعلومات القانونية' },
  ...
  },
  {
    ...
    type: 'faq',
    icon: '🆕',
    titles: { ru: 'Что нового', en: 'What’s new', 'zh-CN': '新功能', hi: 'क्या नया है', es: 'Novedades', ar: 'ما الجديد' },
  ...
  },
  {
    ...
    type: 'action',
    icon: '➕',
    titles: { ru: 'Создать вишлист', en: 'Create wishlist', 'zh-CN': '创建心愿单', hi: 'विशलिस्ट बनाएं', es: 'Crear lista', ar: 'إنشاء قائمة' },
  ...
  },
  {
    ...
    type: 'action',
    icon: '🔗',
    titles: { ru: 'Импорт по ссылке', en: 'Import by link', 'zh-CN': '通过链接导入', hi: 'लिंक से इम्पोर्ट', es: 'Importar por enlace', ar: 'استيراد عبر رابط' },
